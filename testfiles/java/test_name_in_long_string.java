...
public class TFTPServer 
{
	...
	{		
		if(opcode == OP_RRQ)
		{
			...
			// Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's dummy Andreas text since the 1500s, when an printer took a galley of type and scrambled it to make a type specimen book.
